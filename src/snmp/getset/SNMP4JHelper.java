...
public class SNMP4JHelper {
    ...
    public static final String READ_COMMUNITY = "private";
    ...
    public static void main(String[] args) {
        try {
            String strIPAddress = "192.168.88.131";
...
// address.
    ...
    public String snmpGet(String strAddress, String community1, String strOID) {
        String str = "";
        try {
            OctetString community = new OctetString(community1);
            strAddress = strAddress + "/" + SNMP_PORT;
